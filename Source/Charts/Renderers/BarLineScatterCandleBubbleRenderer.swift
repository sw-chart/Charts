...
open class BarLineScatterCandleBubbleRenderer: NSObject, DataRenderer
{
    ...
    public func isInBoundsX(entry e: ChartDataEntry, dataSet: BarLineScatterCandleBubbleChartDataSetProtocol) -> Bool
    {
    ...
    open class XBounds
    {
                      ...
                      animator: Animator?)
        {
            ...
            //Note:- Commented this to fix crash
